// lib/screens/view_mode_screen.dart
...
class _ViewModeScreenState extends State<ViewModeScreen> {
  ...
  Future<void> _fetchFilterOptions() async {
    try {
      ...
      _builtUpAreaOptions = await widget.dbService.fetchDistinctBuiltUpAreas();
  ...
  Future<void> _updateParcel() async {
    ...
    try {
      ...
      if (layer != null && layer is FillLayer) {
        ...
        layer.fillColor = Colors.red.value;
            ...
            child: Row(
              ...
              children: [
                CustomNavigationButton(
                  label: 'Back',
                  onPressed: _previousParcel,
                ),
                const SizedBox(width: 20),
                CustomNavigationButton(
                  label: 'Next',
                  onPressed: _nextParcel,
                ),
                const SizedBox(width: 20),
                CustomNavigationButton(
                  label: 'Filter',
